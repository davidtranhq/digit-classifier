...
{
	std::vector<unsigned int> layer_sizes { 784, 100, 10 };
	...
	network.train(training_examples, 30, 10, 0.5, 5.0, tests,
		Network::Flags::Monitor_eval_accuracy
		| Network::Flags::Early_stop
		| Network::Flags::Schedule_learning_rate);
